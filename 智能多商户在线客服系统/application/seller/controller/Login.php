...
class Login extends Controller
{
    ...
    public function doLogin()
    {
        if(request()->isAjax()){
            ...
            if(md5($password . config('xiaotian.salt')) != $sellerInfo['data']['seller_password']){
    ...
    public function reg()
    {
        ...
        if(request()->isPost()) {
            ...
            $param = [
                ...
                'seller_password' => md5($param['password'] . config('xiaotian.salt')),
                'seller_avatar' => '',
                'seller_status' => 1,
